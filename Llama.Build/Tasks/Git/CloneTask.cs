...
public sealed class CloneTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        ...
        CloneAndCheckout(context, context.LlamaRepositoryName, context.LlamaRepositoryUrl, context.LlamaCppCommitSha);
    }
        ...
        string commitId)
    {
        ...
        if (!context.DirectoryExists(repositoryPath))
        {
            ...
            Repository.Clone(repositoryUrl, repositoryPath.FullPath, new CloneOptions
            {
        ...
        Commands.Fetch(repository, "origin", Array.Empty<string>(), new FetchOptions
        {
