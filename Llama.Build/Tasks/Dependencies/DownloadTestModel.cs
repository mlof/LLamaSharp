...
namespace Llama.Build.Tasks.Dependencies
{
    ...
    public class DownloadTestModelTask : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            ...
            var url = "https://huggingface.co/TheBloke/wizardLM-7B-GGML/resolve/main/wizardLM-7B.ggmlv3.q2_K.bin";
            var fileName = "wizardLM-7B.ggmlv3.q2_K.bin";
            ...
            else
            {
                ...
                context.DownloadFile(url, context.ModelDirectory.CombineWithFilePath(fileName), new DownloadFileSettings());
            }
        }
    }
}
