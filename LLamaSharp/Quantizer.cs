...
namespace LLama
{
    public class Quantizer
    {
        ...
        {
            return new[] { "q4_0", "q4_1", "q5_0", "q5_1", "q8_0" }.Contains(ftype);
        }
        ...
        private static bool ValidateFtype(LLamaFtype ftype)
        {
            return ftype is LLamaFtype.LLAMA_FTYPE_MOSTLY_Q4_0 or LLamaFtype.LLAMA_FTYPE_MOSTLY_Q4_1
                or LLamaFtype.LLAMA_FTYPE_MOSTLY_Q5_0 or LLamaFtype.LLAMA_FTYPE_MOSTLY_Q5_1
                or LLamaFtype.LLAMA_FTYPE_MOSTLY_Q8_0;
        }
        ...
        private static string FtypeToString(LLamaFtype ftype)
        {
            return ftype switch
            {
                ...
                _ => throw new ArgumentException(
                    $"The type {Enum.GetName(typeof(LLamaFtype), ftype)} is not a valid type " +
                    $"to perform quantization.")
            };
        }
